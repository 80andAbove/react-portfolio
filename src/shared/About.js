    ...
    return (
        <div className="section" id="about-me">
          <div className="title-flex">
            ...
            <h2 className="section-title name-title">ShogoMiyagiShogoMiyagiShogoMiyagiShogoMiyagiShogoMiya</h2>
          </div>
          ...
          <div className="me-area">
            ...
            <ul>
              <li className="list-style about-me-stack">
                <span className="connect-with-me">Worked for the Olympics</span>
              </li>
            </ul>
            <ul>
              <li className="list-style about-me-stack">
                <span className="connect-with-me">Aims to continue growing in life</span>
              </li>
            </ul>
            <ul>
              <li className="list-style about-me-stack">
